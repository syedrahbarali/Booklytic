...
export default function BookDetailsComponent() {
  ...
  return <>
    {
      loading ? <div>Loading</div> : <div className="min-h-screen bg-gradient-to-r from-yellow-50 via-pink-50 to-purple-50 p-4 md:p-8">
      <motion.div
      ...
      >
        ...
        <div className="bg-white rounded-2xl shadow-xl p-6 md:p-8 mb-8">
          <div className="flex flex-col md:flex-row gap-8">
            ...
            <div className="flex-1">
              <h1 className="text-3xl md:text-4xl font-bold text-purple-900 mb-2">{book.title}</h1>
              <p className="text-xl text-purple-700 mb-4">by {book.author}</p>
              ...
              <div className="grid grid-cols-2 gap-4 mb-6 text-sm">
                ...
                <div>
                  ...
                  <p className="font-medium">{book.createdAt.split("T")[0]}</p>
                </div>
                <div>
        ...
        {/* Reviews Section */}
        <div className="bg-white rounded-2xl shadow-xl p-6 md:p-8 mb-8">
          <h2 className="text-2xl font-bold text-purple-800 mb-6">Reader Reviews</h2>
                ...
                <div key={rev._id} className="border-b border-gray-100 pb-6 last:border-0 last:pb-0">
                  <div className="flex items-center mb-2">
                    ...
                    <div>
                      ...
                      <p className="text-sm text-gray-500">{rev.createdAt.split("T")[0]}</p>
                    </div>
                  </div>
        ...
        <div className="bg-white rounded-2xl shadow-xl p-6 md:p-8">
          ...
          <button
            ...
            className={`px-6 py-3 rounded-full font-medium ${!userReview?.trim() || userRating === 0 ? 'bg-gray-300 cursor-not-allowed' : 'bg-purple-600 hover:bg-purple-700 text-white'}`}
          >
            Submit Review
          </button>
        </div>
